...
class IOM:
    ...
    CONDTYPE_FRESH_A664FS                = 10
    CONDTYPE_A429SSM_FRESH_A664FS_BNR    = 11
    CONDTYPE_A429SSM_FRESH_A664FS_BCD    = 12
    CONDTYPE_A429SSM_FRESH_A664FS_DIS    = 13
    CONDTYPE_INVALID                     = 14
